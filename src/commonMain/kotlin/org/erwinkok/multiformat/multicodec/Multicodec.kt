...
enum class Multicodec(val typeName: String, val code: Int, val tag: MulticodecTag) {
    ...
    companion object {
        private val codeToName: MutableMap<Int, String> = HashMap()
        private val nameToType: MutableMap<String, Multicodec> = HashMap()
        private val codeToType: MutableMap<Int, Multicodec> = HashMap()
