...
data class Tuple5(
    val code: Multicodec, val length: Int, val input: String, val hex: String, val error: String?,
)
...
internal class MultihashSumTest {
        ...
        return arguments.map { (code, length, input, hex, error) ->
            DynamicTest.dynamicTest(code.typeName) {
                ...
                if (error.isNullOrBlank()) {
                    ...
                    expectError(error) { Multihash.sum(code, input.toByteArray(), length) }
                }
            }
        }.stream()
    }
    ...
    fun smallerLengthHashId() {
        ...
        for (l in data.indices) {
            expectError("the length of the identity hash must be equal to the length of the data") {
                Multihash.sum(
                    Multicodec.IDENTITY,
                    data,
                    l,
    ...
    @Test
    fun tooLargeLength() {
        expectError("requested length was too large for digest of type: sha2-256") {
            Multihash.sum(
                Multicodec.SHA2_256,
                "test".toByteArray(),
                33,
    ...
    companion object {
        var arguments = listOf(
            ...
            Tuple5(
                ...
                -1,
                "foo",
                "c0e40240ca002330e69d3e6b84a46a56a6533fd79d51d97a3bb7cad6c2ff43b354185d6dc1e723fb3db4ae0737e120378424c714bb982d9dc5bbd7a0ab318240ddd18f8d",
                null,
            ),
            Tuple5(
                Multicodec.BLAKE2B_512,
            ...
            Tuple5(
                ...
                -1,
                "foo",
                "ade4022dca82ab956d5885e3f5db10cca94182f01a6ca2c47f9f4228497dcc9f4a0121c725468b852a71ec21fcbeb725df",
                null,
            ),
            Tuple5(
                Multicodec.BLAKE2B_360,
            ...
            Tuple5(
                ...
                -1,
                "foo",
                "b0e40230e629ee880953d32c8877e479e3b4cb0a4c9d5805e2b34c675b5a5863c4ad7d64bb2a9b8257fac9d82d289b3d39eb9cc2",
                null,
            ),
            Tuple5(
                Multicodec.BLAKE2B_384,
            ...
            Tuple5(
                ...
                64,
                "foo",
                "19401af97f7818a28edfdfce5ec66dbdc7e871813816d7d585fe1f12475ded5b6502b7723b74e2ee36f2651a10a8eaca72aa9148c3c761aaceac8f6d6cc64381ed39",
                null,
            ),
            ...
            Tuple5(
                ...
                64,
                "foo",
                "1e4004e0bb39f30b1a3feb89f536c93be15055482df748674b00d26e5a75777702e9791074b7511b59d31c71c62f5a745689fa6c9497f68bdf1061fe07f518d410c0",
                null,
            ),
            Tuple5(
                Multicodec.BLAKE3,
                128,
                "foo",
                "",
                null,
            ),
            ...
            Tuple5(
                ...
                129,
                "foo",
                "",
