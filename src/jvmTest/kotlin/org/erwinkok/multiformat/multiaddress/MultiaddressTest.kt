...
internal class MultiaddressTest {
    ...
    fun `construction fails`(): Stream<DynamicTest> {
        return listOf(
          /*  Pair("/ip4", "failed to parse Multiaddress /ip4: unexpected end of Multiaddress"),
            ...
            Pair("/ip6/::/ipcidr/1026", "failed to parse Multiaddress /ip6/::/ipcidr/1026: Invalid cpidr, must be <256"),
            ...
            Pair("/udp/65536", "failed to parse Multiaddress /udp/65536: Failed to parse address 65536 (> 65535)"),
            Pair("/tcp/65536", "failed to parse Multiaddress /tcp/65536: Failed to parse address 65536 (> 65535)"),
            Pair("/quic/65536", "failed to parse Multiaddress /quic/65536: no protocol with name 65536"),
            Pair("/onion/9imaq4ygg2iegci7:80", "failed to parse Multiaddress /onion/9imaq4ygg2iegci7:80: Invalid onion address host: 9imaq4ygg2iegci7"),
            Pair("/onion/aaimaq4ygg2iegci7:80", "failed to parse Multiaddress /onion/aaimaq4ygg2iegci7:80: failed to parse onion address: aaimaq4ygg2iegci7:80 not a Tor onion address."),
            Pair("/onion/timaq4ygg2iegci7:0", "failed to parse Multiaddress /onion/timaq4ygg2iegci7:0: Port number is not in range(1, 65536): 0"),
            Pair("/onion/timaq4ygg2iegci7:-1", "failed to parse Multiaddress /onion/timaq4ygg2iegci7:-1: Port number is not in range(1, 65536): -1"),
            Pair("/onion/timaq4ygg2iegci7", "failed to parse Multiaddress /onion/timaq4ygg2iegci7: failed to parse onion address: timaq4ygg2iegci7 does not contain a port number"),
            Pair("/onion/timaq4ygg2iegci@:567", "failed to parse Multiaddress /onion/timaq4ygg2iegci@:567: Invalid onion address host: timaq4ygg2iegci@"),
            Pair("/onion3/9ww6ybal4bd7szmgncyruucpgfkqahzddi37ktceo3ah7ngmcopnpyyd:80", "failed to parse Multiaddress /onion3/9ww6ybal4bd7szmgncyruucpgfkqahzddi37ktceo3ah7ngmcopnpyyd:80: Invalid onion address host: 9ww6ybal4bd7szmgncyruucpgfkqahzddi37ktceo3ah7ngmcopnpyyd"),
            Pair("/onion3/vww6ybal4bd7szmgncyruucpgfkqahzddi37ktceo3ah7ngmcopnpyyd7:80", "failed to parse Multiaddress /onion3/vww6ybal4bd7szmgncyruucpgfkqahzddi37ktceo3ah7ngmcopnpyyd7:80: failed to parse onion address: vww6ybal4bd7szmgncyruucpgfkqahzddi37ktceo3ah7ngmcopnpyyd7:80 not a Tor onion address."),
            Pair("/onion3/vww6ybal4bd7szmgncyruucpgfkqahzddi37ktceo3ah7ngmcopnpyyd:0", "failed to parse Multiaddress /onion3/vww6ybal4bd7szmgncyruucpgfkqahzddi37ktceo3ah7ngmcopnpyyd:0: Port number is not in range(1, 65536): 0"),
            Pair("/onion3/vww6ybal4bd7szmgncyruucpgfkqahzddi37ktceo3ah7ngmcopnpyyd:-1", "failed to parse Multiaddress /onion3/vww6ybal4bd7szmgncyruucpgfkqahzddi37ktceo3ah7ngmcopnpyyd:-1: Port number is not in range(1, 65536): -1"),
            Pair("/onion3/vww6ybal4bd7szmgncyruucpgfkqahzddi37ktceo3ah7ngmcopnpyyd", "failed to parse Multiaddress /onion3/vww6ybal4bd7szmgncyruucpgfkqahzddi37ktceo3ah7ngmcopnpyyd: failed to parse onion address: vww6ybal4bd7szmgncyruucpgfkqahzddi37ktceo3ah7ngmcopnpyyd does not contain a port number"),
            Pair("/onion3/vww6ybal4bd7szmgncyruucpgfkqahzddi37ktceo3ah7ngmcopnpyy@:567", "failed to parse Multiaddress /onion3/vww6ybal4bd7szmgncyruucpgfkqahzddi37ktceo3ah7ngmcopnpyy@:567: Invalid onion address host: vww6ybal4bd7szmgncyruucpgfkqahzddi37ktceo3ah7ngmcopnpyy@"),
            Pair(
            ...
            Pair("/garlic32/566niximlxdzpanmn4qouucvua3k7neniwss47li5r6ugoertzu", "failed to parse Multiaddress /garlic32/566niximlxdzpanmn4qouucvua3k7neniwss47li5r6ugoertzu: Invalid garlic addr: 566niximlxdzpanmn4qouucvua3k7neniwss47li5r6ugoertzu not a i2p base32 address. len: 51"),
            Pair("/garlic32/566niximlxdzpanmn4qouucvua3k7neniwss47li5r6ugoertzu77", "failed to parse Multiaddress /garlic32/566niximlxdzpanmn4qouucvua3k7neniwss47li5r6ugoertzu77: Invalid garlic addr: 566niximlxdzpanmn4qouucvua3k7neniwss47li5r6ugoertzu77 not a i2p base32 address. len: 53"),
            Pair("/garlic32/566niximlxdzpanmn4qouucvua3k7neniwss47li5r6ugoertzu:80", "failed to parse Multiaddress /garlic32/566niximlxdzpanmn4qouucvua3k7neniwss47li5r6ugoertzu:80: Invalid garlic addr: 566niximlxdzpanmn4qouucvua3k7neniwss47li5r6ugoertzu:80 not a i2p base32 address. len: 54"),
            Pair("/garlic32/566niximlxdzpanmn4qouucvua3k7neniwss47li5r6ugoertzuq:-1", "failed to parse Multiaddress /garlic32/566niximlxdzpanmn4qouucvua3k7neniwss47li5r6ugoertzuq:-1: invalid value 566niximlxdzpanmn4qouucvua3k7neniwss47li5r6ugoertzuq:-1 for protocol Garlic32: illegal base32 data at input byte 52"),
            Pair("/garlic32/566niximlxdzpanmn4qouucvua3k7neniwss47li5r6ugoertzu@", "failed to parse Multiaddress /garlic32/566niximlxdzpanmn4qouucvua3k7neniwss47li5r6ugoertzu@: invalid value 566niximlxdzpanmn4qouucvua3k7neniwss47li5r6ugoertzu@ for protocol Garlic32: illegal base32 data at input byte 51"),
           ...
           /* Pair("/ip4/127.0.0.1/udp/jfodsajfidosajfoidsa", "failed to parse Multiaddress /ip4/127.0.0.1/udp/jfodsajfidosajfoidsa: Failed to parse address jfodsajfidosajfoidsa"),
            ...
            Pair("/ip4/127.0.0.1/quic/1234", "failed to parse Multiaddress /ip4/127.0.0.1/quic/1234: no protocol with name 1234"),
            Pair("/ip4/127.0.0.1/udp/1234/quic/webtransport/certhash", "failed to parse Multiaddress /ip4/127.0.0.1/udp/1234/quic/webtransport/certhash: unexpected end of Multiaddress"),
            Pair("/ip4/127.0.0.1/udp/1234/quic/webtransport/certhash/b2uaraocy6yrdblb4sfptaddgimjmmp", "failed to parse Multiaddress /ip4/127.0.0.1/udp/1234/quic/webtransport/certhash/b2uaraocy6yrdblb4sfptaddgimjmmp: length greater than remaining number of bytes in buffer"), // 1 character missing from certhash
    ...
    fun conversion(): Stream<DynamicTest> {
        return listOf(
           /* Pair("/ip4/127.0.0.1/udp/1234", "047f000001910204d2"),
            ...
            DynamicTest.dynamicTest("Test: $multiaddress") {
                binary.hexToByteArray()
                val b1 = binary.hexToByteArray()
                val b2 = Multiaddress.fromString(multiaddress).expectNoErrors().bytes
                assertArrayEquals(b1, b2, "Failed to convert $multiaddress to ${b1.toHexString()} got ${b2.toHexString()}")

                val bytes = binary.hexToByteArray()
                val s2 = Multiaddress.fromBytes(bytes).expectNoErrors().toString()
                assertEquals(multiaddress, s2, "Failed to convert ${bytes.toHexString()} to $binary got $s2")
            }
        }.stream()
    }
    ...
    fun `invalid p2p address bytes`() {
        expectError("length greater than remaining number of bytes in buffer") { Multiaddress.fromBytes("a503221221c05877cbae039d70a5e600ea02c6f9f2942439285c9e344e26f8d280c850fad6".hexToByteArray()) }
    }
    ...
    fun `invalid p2p address string`(): Stream<DynamicTest> {
        ...
        return listOf(
            Pair("/p2p/k2k4r8oqamigqdo6o7hsbfwd45y70oyynp98usk7zmyfrzpqxh1pohl-", "failed to parse Multiaddress /p2p/k2k4r8oqamigqdo6o7hsbfwd45y70oyynp98usk7zmyfrzpqxh1pohl-: failed to parse p2p address k2k4r8oqamigqdo6o7hsbfwd45y70oyynp98usk7zmyfrzpqxh1pohl-: invalid base36 digit (-)"), // invalid multibase encoding
            Pair("/p2p/?unknownmultibase", "failed to parse Multiaddress /p2p/?unknownmultibase: failed to parse p2p address ?unknownmultibase: Could not determine Multibase from: ?unknownmultibase"), // invalid multibase encoding
            Pair("/p2p/k2jmtxwoe2phm1hbqp0e7nufqf6umvuu2e9qd7ana7h411a0haqj6i2z", "failed to parse Multiaddress /p2p/k2jmtxwoe2phm1hbqp0e7nufqf6umvuu2e9qd7ana7h411a0haqj6i2z: failed to parse p2p address: k2jmtxwoe2phm1hbqp0e7nufqf6umvuu2e9qd7ana7h411a0haqj6i2z has an invalid codec dag-pb"), // non-libp2p-key codec
            Pair("/p2p/$unknownCodecCID", "failed to parse Multiaddress /p2p/bahkqcerat6dnbamijr6wlgrp5kqmkwwqcwr36ty3fmfyelgrlvwblmhqbiea: failed to parse p2p address: bahkqcerat6dnbamijr6wlgrp5kqmkwwqcwr36ty3fmfyelgrlvwblmhqbiea has an invalid codec md5"), // impossible codec
        ).map { (multiaddress, error) ->
            DynamicTest.dynamicTest("Test: $multiaddress") {
                expectError(error) { Multiaddress.fromString(multiaddress) }
            }
        }.stream()
    }
    ...
    fun manipulationBasic() {
        ...
        assertArrayEquals(udpAddr.bytes, "047f000001910204d2".hexToByteArray())
